#
# Module manifest for module 'Statistics'
#
# Generated by: Nicholas Dille
#
...
FunctionsToExport = 'New-RangeString', 'Get-ExampleTimeSeries', 'Add-Bar', 
               'ConvertFrom-PerformanceCounter', 'ConvertFrom-PrimitiveType', 
               'Expand-DateTime', 'Get-Histogram', 'Get-InterarrivalTime', 
               'Get-SlidingAverage', 'Get-WeightedValue', 'Measure-Group', 
               'Measure-Object', 'Show-Measurement'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/tostka/PowerShell-Statistics'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/tostka/PowerShell-Statistics/releases'
