@{
    ...
    FunctionsToExport = @('New-RangeString', 'Get-ExampleTimeSeries', 'Add-Bar', 'ConvertFrom-PerformanceCounter', 'ConvertFrom-PrimitiveType', 'Expand-DateTime', 'Get-Histogram', 'Get-InterarrivalTime', 'Get-SlidingAverage', 'Get-WeightedValue', 'Measure-Group', 'Measure-Object', 'Show-Measurement')
    CmdletsToExport   = ''
    VariablesToExport = ''
    AliasesToExport   = @('ab', 'cfpc', 'cfpt', 'edt', 'ghist', 'giat', 'gsa', 'gwv', 'mg', 'mo', 'sm')
    FormatsToProcess  = @(
